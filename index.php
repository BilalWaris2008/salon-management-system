                    ...
                    ?>
                        <div class="col-md-6 col-lg-4 mb-6">
                            <div class="single-service-area">
                                ...
                                <p><strong>Price:</strong> <?= number_format($service['price'], 2) ?> PKR</p>
                                <p><strong>Member Price:</strong> <?= number_format($service['member_price'], 2) ?> PKR</p>
